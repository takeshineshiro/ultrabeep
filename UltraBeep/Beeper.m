...

{
	...
	Beeper *THIS = (__bridge Beeper *)inRefCon;
...
void ToneInterruptionListenerBeeper(void *inClientData, UInt32 inInterruptionState)
{
	Beeper *viewController =
    (__bridge Beeper *)inClientData;
...
- (void)createToneUnit
{
	...
	input.inputProc = RenderToneBeeper;
...
- (id)init {
    return [self initWithFrequency:17200];
}
...
- (id)initWithFrequency: (double)freq {
    ...
    OSStatus result = AudioSessionInitialize(NULL, NULL, ToneInterruptionListenerBeeper, (__bridge void *)(self));
